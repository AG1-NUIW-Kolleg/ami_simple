...
n_elements_muscle = [4, 4, 12] # linear elements. each qudaratic element uses the combined nodes of 8 linear elements
n_points_whole_fiber = 30
n_fibers_x = 8
n_fibers_y = 8
...
cellml_file = input_directory+"/shortened_shorten.cellml"
