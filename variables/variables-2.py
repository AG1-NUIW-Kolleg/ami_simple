...
# timing parameters
# -----------------
dt_elasticity = 0.002  # increased to 2ms for faster simulation while maintaining stability
...
end_time = 5.0  # reduced from 20.0 to 5.0ms for faster demonstration (still shows muscle contraction)
...
damping_factor = 0.1                  # velocity dependent damping factor - increased for numerical stability
